        ...
        <motion.div 
          ...
          className="relative w-1/2 mx-auto mb-10">
            ...
            <motion.button
              ...
              onClick={prevImage}
              className="absolute top-1/2 left-[-30] transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full"
            >
              &#10094;
            </motion.button>
            <motion.button
              ...
              transition={{duration: 0.6, delay: 0.8}}
              onClick={nextImage}
              className="absolute top-1/2 right-[-30] transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full"
            >
              &#10095;
            </motion.button>
        </motion.div>
